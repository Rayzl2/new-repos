    ...
    public partial class CustomUserWindowProfile : UserControl
        ...
        private void OnMouseMove(object sender, PointerEventArgs e)
        {
            if (e.GetCurrentPoint(this).Properties.IsLeftButtonPressed)
            {
                ...
                double dx = newMousePosition.X - _lastMousePosition.X;
                var ScrollViewerObj = new ScrollViewer();
                double horizontalOffset = ScrollViewerObj.HorizontalScrollBarValue - dx;
       
                ScrollViewerObj.HorizontalScrollBarValue = horizontalOffset;
